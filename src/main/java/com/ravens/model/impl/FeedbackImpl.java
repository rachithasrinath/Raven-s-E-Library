 ...
 * <ul>
 *   <li>{@link model.impl.FeedbackImpl#getComment <em>Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeedbackImpl extends MinimalEObjectImpl.Container implements Feedback {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.FEEDBACK;
	}
	...
	public EList<String> getComment() {
		if (comment == null) {
			comment = new EDataTypeEList<String>(String.class, this, ModelPackage.FEEDBACK__COMMENT);
		}
		return comment;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.FEEDBACK__COMMENT:
				return getComment();
		}

...
<div class="form-group" style="height: 350px;max-width: 500px; margin: 50px auto 30px;background-color:#fff;
    ...
    <form id="main_form" name="main_form" accept-charset="UTF-8" action="../Patron/docList" method="post" novalidate>
        <h1 class="text-center" style="font-size: 30px; font-family:MYRIAD-PRO;margin-top: 0px;color: #000;">${name} ${subadded}</h1>
        <div style="padding-top:10px">
            <button type="submit" id="submit_btn" class="button btn-danger btn-large " style="font-family:MYRIAD-PRO;"value="Borrow Document">Borrow Document</button>
        </div>
    </form>
    <form id="main_form" name="main_form" accept-charset="UTF-8" action="../Patron/showSubOpt" method="post" novalidate>
        <div style="padding-top:10px">
            <button type="submit" id="submit_btn" class="button btn-success btn-large" style="font-family:MYRIAD-PRO;"value="Subscribe">Subscribe</button>
        </div>
    </form>
</div>

...
<body>
    ...
    <form id="main_form" name="main_form" action="../Patron/patronLoanDoc" method="post" novalidate> 
        <div class="container">
            <div class="col-md-6">
                <div class="pull-left">
            ...
            <div class="table-responsive col-md-12">
                <table class="table table-hidaction table-hover mb30" style="color:#000;background-color: #fff">
                    <thead>
                        <tr>
                            <th style="display: table-cell; font-weight: bold;font-size:14px;padding-top: 8px; line-height: 1.42857143;text-align: center">Borrow</th>
                    ...
                    <tbody>
                        <tr <c:forEach items="${listofdoc}" var="listofdoc"> >
                                <td align="center" class="table-action"><input type="radio"  id="docName"  name="docName" value =${listofdoc.title}>

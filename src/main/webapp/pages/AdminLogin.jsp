...
<head>
    ...
    <title>Raven's Admin | Login</title>
...
<body>
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container-fluid">
                <a class="nav navbar-brand brand center-block" id="nav" href="" style="color:#fff;font-style: italic;font-size: large">
                    RAVEN'S E-Library
                </a>
            </div> 
        </div>
    ...
    <div class="form-group" style="height: 340px;max-width: 400px; margin: 50px auto 30px;background-color:#fff;
        ...
        <form id="main_form" name="main_form" accept-charset="UTF-8" action="../Admin/adminLogin" method="post" novalidate>

...
.navbar-fixed-bottom {
    ...
    <div class="form-group" style="height: 650px;max-width: 600px; margin: 50px auto 30px;background-color:#fff;
        ...
        <form id="main_form" name="main_form" accept-charset="UTF-8" action="../Admin/addCatalogue" method="post" novalidate>
            ...
            <div style="padding-top:10px;margin-bottom: 15px;" class="form-group">
                <label for="documentName" class='pull-left'>Document Name</label>
                    <input type="text" name="title" class="form-control" id="title" value="" required="true"  placeholder="Document Title" style="max-width: 100%" />
            </div>
            <div style="padding-top:10px;margin-bottom: 15px;" class="form-group">
                <label for="authorName" class='pull-left'>Author Name</label>
                <input type="text" name="authorname" id="authorname" class="form-control" value="" required="true" placeholder="Author Name" style="background-color: white" />
            </div>
             <div style="padding-top:10px;margin-bottom: 15px;" class="form-group">
                <label for="publication" class='pull-left'>Publication</label>
                <input type="text" name="publication" id="publication" class="form-control" value="" required="true" placeholder="Publication" style="background-color: white" />
            </div>
            
            
             <div style="padding-top:10px;margin-bottom: 15px;" class="form-group">
                <label for="edition" class='pull-left'>Edition</label>
                <input type="text" name="edition" id="edition" class="form-control" value="" required="true" placeholder="Edition" style="background-color: white" />
            </div>
             <div style="padding-top:10px;margin-bottom: 15px;" class="form-group">
                <label for="publicationDate" class='pull-left'>Published Date</label>
                <input type="text" name="publicationDate" id="publicationDate" class="form-control" value="" required="true" placeholder="Published Date" style="background-color: white" />
            </div>
